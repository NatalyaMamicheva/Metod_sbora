...
for i in range(last_page):
    ...
    for vacancy in vacancies:
        ...
        vacancy_id = re.split('/', vacancy_href)[4]
        vacancy_info['_id'] = vacancy_id[:8]
...
# Вывод вакансий, где зп "От" больше 90000 или "До" больше или равняется 145000
def vacancy_salary():
    for z in vacancy_new.find({"$or": [{'От': {'$gt': 90000}}, {'До': {'$gte': 145000}}]}):
        pprint(z)
